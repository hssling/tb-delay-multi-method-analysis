"""Master runner for the TB delay automation pipeline - Version 2 with updated data sources."""
...
SCRIPTS = [
    "scripts/01_ingest_sources_v2.py",  # Updated ingestion
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the full TB delay pipeline - Version 2")
    parser.add_argument(
        "--stop-on-error",
        action="store_true",
